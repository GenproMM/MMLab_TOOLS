# -*- coding: utf-8 -*-
"""
Плавающее (modeless) окно результатов проверки.
Expander на каждую категорию, клик по элементу выделяет в модели Revit.
...
class ResultsWindow(Window):
    ...
    def __init__(self, doc, results):
        ...
        {
            "category_name": [list of {"id": ElementId, "name": str}],
            ...
        }
        """
        self.Title = u"\u0420\u0435\u0437\u0443\u043b\u044c\u0442\u0430\u0442\u044b \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0438"
        self.Width = 650
        self.Height = 520
    ...
    def _build_ui(self):
        ...
        top.Children.Add(_make_title(
            u"\u0420\u0435\u0437\u0443\u043b\u044c\u0442\u0430\u0442\u044b \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0438"
        ))
        ...
        btn_close = _make_secondary_button(
            u"\u0417\u0430\u043a\u0440\u044b\u0442\u044c",
            self._on_close,
        )
        ...
        for cat_name, elements in self._results.items():
            ...
            if count > 0:
                header.Foreground = _FG_ERROR
            else:
                header.Foreground = _FG_SUCCESS
