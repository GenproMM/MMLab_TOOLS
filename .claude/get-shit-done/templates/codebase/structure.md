...
- Usage: Reference from command with `@G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
