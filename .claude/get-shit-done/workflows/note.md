...
- **Global scope**: `G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/notes/`)
...
2. Glob `G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/notes/*.md` (if directory exists) — global notes
...
Global (G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `G:/Мой диск/02_DEV/01_Python/GENPRO LAB/MMLab_TOOLS/.claude/notes/` — works in any directory
